...
parser.add_argument('-t', '--input_size', type=int, required=True, help="Tamanho da entrada para o algoritmo")
parser.add_argument('-n', '--num_executions', type=int, required=True, help="Número de vezes que o algoritmo será executado")
args = parser.parse_args()

average_time = run_multiple_executions(args.algorithm, args.input_size, args.num_executions)
print(f"Algoritmo: {args.algorithm.capitalize()} | Tamanho da Entrada: {args.input_size} | Número de Execuções: {args.num_executions} | Tempo Médio de Execução: {average_time:.6f} segundos")
